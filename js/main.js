...
function swaptext_ourgallery(){
	var btns = $('#btnst_ourgallery').text();
	if (btns == "CLICK HERE"){
		document.getElementById("btnst_ourgallery").innerHTML = "GALLERY";
	}else{
		document.getElementById("btnst_ourgallery").innerHTML = "CLICK HERE";
	}
}
